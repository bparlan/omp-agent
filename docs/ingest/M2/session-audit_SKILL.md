---
generated-from: skills/session-audit/SKILL.md
generated-date: 2026-07-18
original-file: skills/session-audit/SKILL.md
ingestion-folder: M2
delegated-to: sync-documentation
context: Standard sync — Update with new features
action: MODIFIED
file-size: 8797 bytes
---
...
-   Generate TEMP-specific documentation in /docs/ingest/TEMP/
...
Ingestion entries are generated for ALL modified files. The manage-roadmap skill will:
1. Check for files in /docs/ingest/
2. Ask user for permission
3. Ask user for context
4. Delegate to appropriate skill
5. Archive original file after processing

No automatic change detection needed — user controls what gets ingested.
...
**Original File**: skills/session-audit/SKILL.md
**Original Size**: 8797 bytes
**Ingested Date**: 2026-07-18
**Delegated To**: sync-documentation
**Processing Context**: Standard sync — Update with new features
